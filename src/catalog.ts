...
export const CATALOG: ObjectDef[] = [
  ...
  { id: 'mezzanine', label: 'Mezzanine Floor', category: 'mezzanine', w: 10.0, d: 6.0, h: 3.0, color: '#dcbd90', rule: 'floor' },
  { id: 'stairs', label: 'Staircase', category: 'stairs', w: 2.0, d: 4.0, h: 3.0, color: '#b0a695', rule: 'floor' },
