...
export const CATALOG: ObjectDef[] = [
  ...
  // fitness wall mirror: put it flush against any partition or room wall
  { id: 'mirror', label: 'Wall Mirror (fitness)', category: 'fixture', w: 3.0, d: 0.06, h: 2.0, color: '#c8d8de', rule: 'floor' },
